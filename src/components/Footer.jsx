    ...
    <section>
      <div className="border border-[#1CBCCF]/40 rounded-t-[60px] sm:rounded-t-[100px] md:rounded-t-[200px] pt-16">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 text-gray-700 text-sm">
              <a href="mailto:contact@insove.com" className="flex items-center gap-2 hover:text-[#1CBCCF] transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
              ...
              <a href="tel:+14146875892" className="flex items-center gap-2 hover:text-[#1CBCCF] transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
              ...
              <a href="#" className="flex items-center gap-2 hover:text-[#1CBCCF] transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-gray-700 text-sm">
              <a href={`${baseUrl}/`} className="hover:text-[#1CBCCF] hover:underline transition-all duration-300">Home</a>
              <a href={`${baseUrl}/clinics`} className="hover:text-[#1CBCCF] hover:underline transition-all duration-300">Clinics</a>
              <a href={`${baseUrl}/login`} className="hover:text-[#1CBCCF] hover:underline transition-all duration-300">Login</a>
              <a href={`${baseUrl}/register`} className="hover:text-[#1CBCCF] hover:underline transition-all duration-300">Register</a>
              <a href={`${baseUrl}/clinic-register`} className="hover:text-[#1CBCCF] hover:underline transition-all duration-300">Apply as Clinic</a>
            </div>
          </div>
        </div>
        ...
        <div className="text-center sm:flex sm:justify-between sm:px-16 lg:px-40 xl:px-52 2xl:px-60 py-5 text-sm text-gray-600 gap-2">
          ...
          <div>
            All Rights Reserved |
            <a href={`${baseUrl}/terms`} className="text-blue-500 underline mx-1 hover:text-blue-600 transition-colors duration-300">
              Terms
            </a>{" "}
            |
            <a href={`${baseUrl}/privacy`} className="text-blue-500 underline ml-1 hover:text-blue-600 transition-colors duration-300">
              Privacy
            </a>
          </div>
        </div>
